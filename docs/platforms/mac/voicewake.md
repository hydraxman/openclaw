...
- Replies are delivered to the **last-used main provider** (Telegram/Discord/WebChat). If delivery fails, the error is logged and the run is still visible via WebChat/session logs.
